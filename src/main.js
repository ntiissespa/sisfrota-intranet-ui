...
import Util from "./utilities/utils/Util";
import Firebase from "./firebaseApp";

import "hover.css";

import Token from "./utilities/jwt/Token";
import ImageCropper from "./utilities/utils/ImageCropper";
...
app.config.globalProperties.$ImageCropper = new ImageCropper();
app.config.globalProperties.$Token = new Token();
app.config.globalProperties.$Util = new Util();
app.config.globalProperties.$UrlIntranet = "http://localhost:8081/"; // TODO: MUDAR A URL EM PRODUÇÃO
