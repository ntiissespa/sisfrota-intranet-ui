<template>
  ...
  <div class="p-grid">
    <div class="p-col-12">
      <Panel header="Gerenciamento de Pneus">
        ...
        <DataTable
          ...
          currentPageReportTemplate="Exibindo de {first} a {last} no total de {totalRecords} pneus."
          :loading="loading"
        >
          <template #empty>
...
export default {
  ...
  methods: {
    showCreate() {
      this.obj = new Tire();
      this.$store.state.views.tire.dialogForm = true;
    },
    showUpdate(obj) {
      this.obj = obj;
      this.$store.state.views.tire.dialogForm = true;
