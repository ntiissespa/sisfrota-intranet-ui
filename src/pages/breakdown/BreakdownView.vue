<template>
  ...
  <div class="p-grid">
    <div class="p-col-12">
      <Panel header="Gerenciamento de Avarias">
        ...
        <DataTable
          ...
          currentPageReportTemplate="Exibindo de {first} a {last} no total de {totalRecords} avarias."
          :loading="loading"
        >
          <template #empty>
...
//models
import Breakdown from "../../models/internal/breakdown";
//Services
...
export default {
  ...
  methods: {
    showCreate() {
      this.obj = new Breakdown();
      this.$store.state.views.breakdown.dialogForm = true;
    },
    showUpdate(obj) {
      this.obj = obj;
      this.$store.state.views.breakdown.dialogForm = true;
